          ...
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto ">
                ...
                <li><a href="login.php" class="nav-link">Sign Out</a></li>
              </ul>
            </nav>
          </div>
            ...
            <div class="row">
              <div class="col-md-6 text-center mb-4">
                <div class="service-38201">
                  ...
                  <a href="service1.php">Insurance</a>
                  <p>Management</p>
                </div>
              </div>
              <div class="col-md-6 text-center mb-4">
                <div class="service-38201">
                  ...
                  <a href="service2.php">Smart Bathub</a>
                  <p>Management</p>
                </div>
              </div>
              <div class="col-md-6 text-center mb-4">
                <div class="service-38201">
                  ...
                  <a href="service3.php">Smart Air</a>
                  <p>Management</p>
                </div>
              </div>
              <div class="col-md-6 text-center mb-4">
                <div class="service-38201">
                  ...
                  <a href="service4.php">Smart Control</a>
                  <p>Management</p>
                </div>
              </div>
            </div>
