          ...
          <div class="col-9  text-right">
            ...
            <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
              <ul class="site-menu main-menu js-clone-nav ml-auto ">
                ...
                <li class="active"><a href="service.php" class="nav-link">Service</a></li>
    ...
    <div class="container">
      <div class="row align-items-stretch">
          ...
          <div class="h-100 p-5 bg-black">
            <center>
                <div class="service-38201">
                  ...
                  <h3>Smart Bathub</h3>
                  <p>Management</p>
                  <p>***Cover around the clock - 24 hours, 7 days a week, 365 days a year</p>
                   <p>***Burst pipes, plumbing and drainage problems</p>
                    <p>***Securing your property in response to problems like smashed windows</p>
                     <p>***Boiler breakdown, including heating and hot water failures</p>
                     <p>***We aim to get a fully qualified tradesman out to you within 2 hours</p>
                </div>
          </center>
          </div>
        </div>
        <div class="col-lg-5 ml-auto">
          ...
          <p class="mb-5">SmartFx gather all your family with our technology</p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-6 text-center">
          ...
          <p class="mb-5 text-white">From all around Indonesia</p>
        </div>
      </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="post-entry-1 h-100">
                ...
                <div class="post-entry-1-contents">
                  ...
                  <span class="meta d-inline-block mb-3">March 27, 2019 <span class="mx-2">by</span> <a
                      href="#">Admin</a></span>
                  <p>Large Packet</p>
                </div>
              </div>
